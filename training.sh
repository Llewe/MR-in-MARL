...
#train AGENT_TYPE=ma_social_wellfare_mate NAME="RMP-SW (MATE-TD, x=-0.5)" NAME= EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-0.5
#train AGENT_TYPE=ma_social_wellfare_mate NAME="RMP-SW (MATE-TD, x=-1)" NAME= EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-1.0
#train AGENT_TYPE=ma_social_wellfare_mate NAME="RMP-SW (MATE-TD, x=-2)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-2.0
#train AGENT_TYPE=ma_social_wellfare_ac NAME="RMP-SW (AC, x=-0.5)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-0.5
#train AGENT_TYPE=ma_social_wellfare_ac NAME="RMP-SW (AC, x=-1)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-1.0
#train AGENT_TYPE=ma_social_wellfare_ac NAME="RMP-SW (AC, x=-2)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-2.0
