...
train AGENT_TYPE=random EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000"
train AGENT_TYPE=a2c EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=a2c EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.0001 CRITIC_LR=0.0001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=a2c EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
train AGENT_TYPE=a2c EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.0001 CRITIC_LR=0.0001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1

train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=0.2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=0.8 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=1 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=1.2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=2e-05 EPSILON_MIN=0.1

train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=0.2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=0.8 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=1 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=1.2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
train AGENT_TYPE=mate EPOCHS=50000 ENV_NAME=p_my_coin_game ENV_TAG="50000" DISCOUNT_FACTOR=0.95 TOKEN_VALUE=2 ACTOR_LR=0.001 CRITIC_LR=0.001 EPSILON_INIT=0.8 EPSILON_DECAY=4.66e-05 EPSILON_MIN=0.1
