...
#train AGENT_TYPE=ma_ipd_punish_defect NAME="RMP-PD (x=2.0)" EPOCHS=5000 ENV_NAME=p_prisoners_dilemma ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=2.0
