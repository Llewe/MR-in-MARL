...
train AGENT_TYPE=actor_critic NAME="Actor Critic" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 MANIPULATION_AMOUNT=1.0
...
train AGENT_TYPE=mate NAME="MATE-Value-Decompose" MODE="value_decompose" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="n-4pl-5000" DISCOUNT_FACTOR=0.95 MANIPULATION_AMOUNT=1.0
train AGENT_TYPE=gifting NAME="Gifting-Zero-Sum" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="zero_sum" ACTION_MODE="random"
train AGENT_TYPE=gifting NAME="Gifting-Zero-Sum" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="zero_sum" ACTION_MODE="random"
train AGENT_TYPE=gifting NAME="Gifting-Fixed-Budget (10)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="fixed_budget" ACTION_MODE="random"
train AGENT_TYPE=gifting NAME="Gifting-Fixed-Budget (10)" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="fixed_budget" ACTION_MODE="random"
train AGENT_TYPE=gifting NAME="Gifting-Replenishable-Budget" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="replenishable_budget" ACTION_MODE="random"
train AGENT_TYPE=gifting NAME="Gifting-Replenishable-Budget" EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="default-5000" DISCOUNT_FACTOR=0.95 GIFT_REWARD=1.0 GIFT_MODE="replenishable_budget" ACTION_MODE="random"
...
train AGENT_TYPE=ma_coin_to_middle_mate NAME="RMP (MATE-TD, x=-1)" NAME= EPOCHS=5000 ENV_NAME=p_coin_game ENV_TAG="4n-pl-5000" DISCOUNT_FACTOR=0.95 ACTOR_LR=0.001 CRITIC_LR=0.001 MANIPULATION_AMOUNT=-1.0
